...
def explorer(launcher: Launcher):
    ...
    sub = launcher.bind_(
        {
            ...
            "test.shifts": 0,
            "model": "htdemucs",
            "htdemucs_mlx.dconv_mode": 3,
            "htdemucs_mlx.depth": 4,
            "htdemucs_mlx.t_dropout": 0.02,
            "htdemucs_mlx.t_layers": 5,
            "max_batches": 800,
            "ema.epoch": [0.9, 0.95],
    ...
    sparse = {
        ...
        'htdemucs_mlx.t_auto_sparsity': True,
        'htdemucs_mlx.t_sparse_self_attn': True,
        'htdemucs_mlx.t_sparse_cross_attn': True,
        'htdemucs_mlx.t_sparsity': 0.9,
        "htdemucs_mlx.t_layers": 7
    }
    ...
    with launcher.job_array():
        for transf_layers in [5, 7]:
            for bottom_channels in [0, 512]:
                sub = launcher.bind({
                    "htdemucs_mlx.t_layers": transf_layers,
                    "htdemucs_mlx.bottom_channels": bottom_channels,
                })
                if bottom_channels == 0 and transf_layers == 5:
                    ...
                    sub(sparse, {'dset.segment': 15, "htdemucs_mlx.t_layers": 7})

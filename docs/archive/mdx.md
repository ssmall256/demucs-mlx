...
Follow the instructions in this repo's README to install dependencies with `pip` and enable training extras.
You will need the full setup for training, including soundstretch.
